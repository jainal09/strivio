...
6. After Coding is done create a file 🗃️ **"lang.yaml"**
...
14. Select your last commit, click **build**, wait for the **Build jainal09/strivio@Production** to turn green ✔️ and after that  click on Results 🤞
